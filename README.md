...
## Agenda 
 ...
 1. Docker-Grundlagen 
  ...
  1. Docker Alternativen
     * [Docker Alternativen](docker/alternativen.md)
  ...
  1. Docker-Installation & Konfiguration & Sicherheit
     ...
     * [Konfig-Fehler in der daemon.json - für die Konfiguration des Docker-Dienstes](/docker/configuration/daemon-json.md)
 ...
 1. Kubernetes Praxis API-Objekte 
  ...
  1. Kubernetes Ingress (Traefik)
     ...
     * [Übung: Ingress mit Traefik und Hostnamen](kubectl-examples/04-ingress-traefik-with-hostnames-deployment.md)
     * [Übung: HTTPS/TLS mit Let's Encrypt - cert-manager](ingress/https-letsencrypt-ingress-traefik.md)
